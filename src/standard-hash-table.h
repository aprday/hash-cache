/*
 * standard-hash-table.h
 *
 *  Created on: Jun 16, 2015
 *      Author: root
 */

#ifndef STANDARD_HASH_TABLE_H_
#define STANDARD_HASH_TABLE_H_
...
class StandardHashTable {
 ...
 private:
  ...
  static const int NODES = 316; /*RAM_BUDGET * BUCKET_TO_NODE_DENOMINATOR /
